		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" method="login.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password must be 8 characters or more">
					...
					<div class="wrap-input100 validate-input" data-validate = "Passwords must match">
						<input class="input100" id="passwordconfirm" type="password" name="passconfirm" maxlength="500" placeholder="Confirm Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
