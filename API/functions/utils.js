...
module.exports = {
    ...
    decodeCredentialPublicKey: function (array) {
        ...
        //console.log('X', this.array2hex(credentialPublicKey[cose_crv_x]));
        //console.log('Y', this.array2hex(credentialPublicKey[cose_crv_y]));
    ...
    allowed: (id, allowCredentials) => {
        ...
        //console.log('valid Credential ID');
    },
    ...
    verify: function (publicKey, data, derSig) {
        ...
        let msgHash = this.hash(Buffer.from(data));//Updated deprecated new buffer to buffer from
